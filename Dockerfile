...
WORKDIR $GOPATH/src/github.com/object-manager
...
COPY --from=builder /go/src/github.com/object-manager/cmd /

ENTRYPOINT ["/object-manager","--profile=docker","--registry=true"]
